...
//
//@Component
//public abstract class BaseDataProcessor<T> extends AbstractDataProcessor<List<T>>{
//	
//	@Autowired
...
//	
//	
//	public abstract List<T> process(String hr);
//	
//	@Override
//	public void doDataProcess(String str){
//		//处理数据
//		List<T> datas = process(str);
//		
//		try {
//			//存入db
//			toDB(datas);
//			
//			//获取redis中相同key的数据
////			List<T> bvcs = getDataFromRedis(datas);
//			
//			//找到不重复的数据
